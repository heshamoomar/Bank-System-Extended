...
public:
    ...
    static bool CurrencyExistsbyCode(string CurrencyCode)
    {
    ...
    static bool CurrencyExistsbyName(string CurrencyName)
    {
        clsCurrency C1 = clsCurrency::FindByCountry(CurrencyName);
        return (!C1.isEmpty());
